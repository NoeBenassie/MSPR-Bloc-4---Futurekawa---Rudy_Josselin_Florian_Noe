#!/usr/bin/env python3
"""
Génère documentation-ci-cd-futurekawa.pdf à partir des fichiers Markdown du dossier ci-cd/.
Usage : python livrables/ci-cd/generate-pdf.py
...
OUTPUT_PDF = os.path.join(PDF_DIR, "documentation-ci-cd-futurekawa.pdf")
...
@page {
    ...
    @bottom-center {
        content: "FutureKawa — Pipeline CI/CD";
        font-size: 9pt;
        color: #aaa;
    }
}
