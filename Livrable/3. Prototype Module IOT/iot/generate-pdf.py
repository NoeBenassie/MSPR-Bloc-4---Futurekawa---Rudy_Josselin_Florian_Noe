#!/usr/bin/env python3
"""
Génère documentation-iot-futurekawa.pdf à partir des fichiers Markdown du dossier iot/.
Usage : python livrables/iot/generate-pdf.py
...
OUTPUT_PDF = os.path.join(PDF_DIR, "documentation-iot-futurekawa.pdf")

FILES = [
    "README.md",
    "01-vue-ensemble.md",
    "02-materiel-cablage.md",
    "03-code-arduino.md",
    "04-configuration.md",
    "05-flux-donnees.md",
    "06-validation-donnees.md",
    "07-deploiement.md",
    "08-tests.md",
]
